...
1. screenshot-1 - Available Plugin Options in Admin.
2. screenshot-2 - World Map.
3. screenshot-3 - Continent Map (Asia).
4. screenshot-4 - Continent Map (Africa).
5. screenshot-5 - Country Map (USA).
6. screenshot-6 - Country Map (Australia).
